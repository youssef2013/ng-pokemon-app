...
var BorderCardDirective = (function () {
    function BorderCardDirective(el) {
        ...
        this.defaultHight = 180;
        this.setBorder(this.defaultColor);
        this.setHeight(this.defaultHight);
    }
    BorderCardDirective.prototype.onMousEnter = function () {
        this.setBorder(this.borderColor || this.initialColor);
    };
    BorderCardDirective.prototype.onMousLeave = function () {
        this.setBorder(this.defaultColor);
    };
    ...
    ], BorderCardDirective.prototype, "onMousEnter", null);
    __decorate([
        core_1.HostListener('mouseleave'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], BorderCardDirective.prototype, "onMousLeave", null);
